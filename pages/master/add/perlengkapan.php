    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Form Data perlengkapan</h5>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_perlengkapan" id="nama_perlengkapan" required>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-3 d-flex flex-column">
                                <button name="insert_perlengkapan" type="submit" class="btn btn-primary">Simpan Data</button>
                            </div>
                        </form>
                    </div>
                </form>
